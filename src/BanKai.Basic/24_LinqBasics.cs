...
namespace BanKai.Basic
{
    public class Linq2ObjectBasics
    {
        ...
        public void should_filtering_elements_using_where()
        {
            ...
            IEnumerable<string> filteredResult = sequence.Where(item => item.Length == 5);  //方法语法
        ...
        public void should_get_sequence_excpetions()
        {
            ...
            IEnumerable<int> except = firstSequence.Except(secondSequence);  //firstSequence有，而secondSequence没有
        ...
        public void should_get_ordered_sequence()
        {
            ...
            IOrderedEnumerable<int> orderedResult = sequence.OrderBy(item => item); //OrderBy默认升序，使用ascending和sescending显式控制升序降序
